...
function get_siteemail() {
  return 'emmadibe33@gmail.com.com';
}
 ...
 * @return string
 */
function insert_inputs() { //Esta función inserta varios inputs a nuestros formularios; entre ellos, el token CSRF para evitar hackeos. Los tokens CSRF, que son tokens que funcionan validándose entre el formulario y la petición donde se procesa. Si no coinciden ambos token significa que nuestro formulario NO se está enviando desde nuestro propio sitio, sino que se envía desde otro lado. No lo dejamos pasar a la información. Así, se evitan ataques cibernéticos.
	$output = '';
